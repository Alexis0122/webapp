...
export const GratificationProjectSchema: ObjectSchema<ProjectGratificationForm> = object().shape({
  ...
  amount: yup.number().moreThan(0, 'El monto debe ser mayor a 0.').required('Campo obligatorio').typeError('Campo obligatorio'),
  imageUrl:
    yup.object().shape({
